  ...
  return (
    <motion.div
      ...
      className={`
            ...
            after:left-0 after:top-0 after:z-1 after:h-full after:w-full after:rounded-lg after:opacity-0 after:transition-all after:duration-500 after:content-[''] hover:before:opacity-100 
			      group-hover:after:opacity-100`}
    >
      <motion.div className=" inset-[1.5px] z-2 h-[calc(100%-3px)] w-[calc(100%-3px)] rounded-lg bg-zinc-800 p-8">
        {children}
      </motion.div>
    </motion.div>
  );
