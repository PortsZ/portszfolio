...
const antaresTechStack = [
  ...
  "Prototyping on Figma and blender",
];
...
export const antares = {
  ...
  preview: {
    ...
    figma:
      "https://www.figma.com/file/kIw5lki20Ieh2fLl6qxiW0/Dimensionar?type=design&node-id=0%3A1&mode=design&t=1Za6i5kYZCirWmhY-1",
    description:
      "A solar energy software that offers a PV Kit Sizer and a proposal generator.",
    shortStack:
      "Laravel, Python, Next.js, Prisma, Planetscale, MySQL, AWS, Vercel",
  },
};
...
export const martPlus = {
  ...
  features: [
    ...
    "Authentication",
    "Databases",
    "Beautiful and responsive Front-end",
  ],
  techStack: antaresTechStack,
  mockup: "/mart-plus/mart-plus-mockup.png",
  responsibilities:
    "Engineered a comprehensive CRUD system for a supermarket application, facilitating seamless management of products, categories and tax. Implemented robust shopping cart and checkout functionalities, allowing users to interact, add products, and manage transactions efficiently. Executed proficient deployment of the project on Vercel, ensuring optimal performance and user experience.",
  preview: {
    ...
    description:
      "A Supermaket CRUD with a shopping cart and a checkout system.",
...
export const volumeSpikeBot = {
  ...
  responsibilities:
    "Developed a trading bot that uses volume spikes to predict price movements and track institutional activity. The bot is able to track all Binance pairs in parallel and send notifications to a Desired Email. The bot runs on CLI and was made for a client.",
  preview: {
    logo: "/volume-bot/volume-bot-logo.png",
    title: "Volume Spike Trading Bot",
    code: "https://github.com/PortsZ/volume-spike-trade-bot",
    description:
      "A trading bot that uses volume spikes to predict price movements and track institutional activity.",
